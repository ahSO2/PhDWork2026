...
location_means_row = {"location":"Location_Means",
                      ...
                      "PP": outputs_df["PP"].mean(),
                      "PN": outputs_df["PN"].mean(),
                      "RP": outputs_df["RP"].mean(),
                      "RN": outputs_df["RN"].mean(),
                      "R_No": outputs_df["RN"].mean(),
                      "R_Minor": outputs_df["R_Minor"].mean(),
                      "R_NotCalc": outputs_df["R_NotCalc"].mean(),
