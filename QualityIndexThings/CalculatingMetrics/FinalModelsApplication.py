...
outputs_save_path = "FinalModelsApplicationOutputs_RetrainedPrecipModel/"  #Predictions saved here
...
image_names_df.to_excel(outputs_save_path + image_names_path.split("/")[-1][:-5] + ".xlsx")
