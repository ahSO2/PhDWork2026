...
save_path = "C:/Users/ggp24ash/Documents/Quality Index Write Up/Version for submission - R2/Figures/Figure7.jpg"
df1 = pd.read_excel("C:/Users/ggp24ash/PycharmProjects/PhDWork2026/QualityIndexThings/CalculatingMetrics/FinalModelsApplicationOutputs_RetrainedPrecipModel/Precipitation_Full_TestUnseen.xlsx")
target1 = "precipitation"
title1 = "A) Precipitation"
df2 = pd.read_excel("C:/Users/ggp24ash/PycharmProjects/PhDWork2026/QualityIndexThings/CalculatingMetrics/FinalModelsApplicationOutputs_RetrainedPrecipModel/Cloud_Full_TestUnseen.xlsx")
target2 = "obs_cloud"
title2 = "B) Cloud"
...
cm = 1 / 2.54
fig, axs = plt.subplots(ncols=1, nrows=2, figsize=(15*cm, 15*cm))
...
count_dfs = [counts1, counts2]
norm_dfs = [norm1, norm2]
...
axs[1].set_xticks([0, 1, 2, 3, 4], labels=["No", "Minor", "NotCalc", "InCalc", "Very"])
axs[0].tick_params(axis="x", which="both", bottom=False, top=False, labelbottom=False)
#axs[].tick_params(axis="x", which="both", bottom=False, top=False, labelbottom=False)
#axs[0].set_ylabel("Predicted", fontsize=15, labelpad=15)
fig.supylabel("Predicted", fontsize=15, x=0.14, y=0.64)
axs[1].set_xlabel("Manual Label", fontsize=15)
plt.subplots_adjust(wspace=0, hspace=0.3)
fig.colorbar(plot2, ax=axs[0:2], location="bottom", shrink=0.7, pad=0.20,
